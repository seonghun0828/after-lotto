...
export default function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <Link
      ...
      key={id}
      className='bg-[#383838] flex aspect-[12/4] gap-[12px] rounded-[20px] p-[12px] justify-between'
    >
      <div className='flex flex-col gap-[12px] max-w-[340px] truncate whitespace-pre-line'>
