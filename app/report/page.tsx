    ...
    <main>
      ...
      <div>
        <ul className="bg-[#383838] px-[40px]">
          {listItem.map((item, index) => (
            <li key={item.title + index} className="border-b pb-[24px] pt-[24px] last:border-none">
              <div className="">
                <p className="inline-flex items-center bg-[#222] rounded-full px-[16px] py-[8px] mb-[8px] gap-[4px] ">
                  <Image src={computerIcon} alt={item.title} className="w-[16px] h-auto text-[]" />
                ...
                <div className="flex items-center text-white gap-4">
                  ...
                  <div className="flex gap-[26px] items-center text-[20px]">
                    ...
                    <p className="min-w-[40px]">{item.percentage}%</p>
                  </div>
                </div>
              </div>
            </li>
      ...
      <div className="px-[40px] py-[24px]">
        <div className="flex items-center justify-end gap-[30px]">
          ...
          <div className="text-[20px] p-[8px]">96%</div>
        </div>
      </div>
    </main>
  );
